...
Page({
	...
	onLoad: async function (options) {
		...
		let articleContentRes = await service.request('/newsitems/' + this.data.articleInfo.Id + '/body')
		wxParse.wxParse('articleContent', 'html', articleContentRes.data, this, 8)

		let articleCommentsRes = await service.request('/news/' + this.data.articleInfo.Id + '/comments', {
			pageIndex: 1,
			pageSize: 100
		})
